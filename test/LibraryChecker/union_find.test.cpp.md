...
data:
  ...
  bundledCode: "#line 1 \"test/LibraryChecker/union_find.test.cpp\"\n#define PROBLEM\
    ...
    \ == rnk[v];\n        par[v] = par[u];\n        wt[u] += wt[v];\n    }\n\n   \
    \ int get_wt(int v) {\n        return wt[find(v)];\n    }\n};\n#line 5 \"test/LibraryChecker/union_find.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/LibraryChecker/union_find.test.cpp
- /verify/test/LibraryChecker/union_find.test.cpp.html
